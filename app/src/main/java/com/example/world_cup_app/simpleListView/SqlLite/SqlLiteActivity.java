package com.example.world_cup_app.simpleListView.SqlLite;
...
import com.example.world_cup_app.simpleListView.SqlLite.adapter.ContactsAdapter;
import com.example.world_cup_app.simpleListView.SqlLite.db.DatabaseHelper;
...
public class SqlLiteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Toolbar
        Toolbar toolbar = findViewById(R.id.toolbar_tool);
        ...
        contactsAdapter = new ContactsAdapter(this, contactArrayList,SqlLiteActivity.this);
    ...
    public void addAndEditContacts(final boolean isUpdated,final Contact contact,final int position) {
        ...
        AlertDialog.Builder alerDialogBuilder = new AlertDialog.Builder(SqlLiteActivity.this);
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(newContact.getText().toString())){
                    Toast.makeText(SqlLiteActivity.this, "Please Enter a Name", Toast.LENGTH_SHORT).show();
