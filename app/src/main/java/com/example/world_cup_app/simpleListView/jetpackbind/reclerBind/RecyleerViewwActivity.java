...
import com.example.world_cup_app.databinding.ActivityRecyleerViewwBinding;

import java.util.ArrayList;
import java.util.concurrent.ExecutorService;
import java.util.concurrent.Executors;

public class RecyleerViewwActivity extends AppCompatActivity {
    private ContacctAppDatabase contactAppDatabase;
    private ArrayList<Contact> contacts = new ArrayList<>();
    private ContactDataAdapter contactDataAdapter;

    // Binding
    private ActivityRecyleerViewwBinding activityMainBinding;
    private MainActivityClickHandlers handlers;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recyleer_vieww);
        // Data Binding
        activityMainBinding = DataBindingUtil.setContentView(this, R.layout.activity_recyleer_vieww);
    ...
    public class MainActivityClickHandlers{
        ...
        public void onFABClicked(View view){
            Intent i = new Intent(RecyleerViewwActivity.this, AddNeewContactActivity.class);
