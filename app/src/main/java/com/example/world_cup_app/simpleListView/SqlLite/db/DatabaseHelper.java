package com.example.world_cup_app.simpleListView.SqlLite.db;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabaseb) {
        sqLiteDatabaseb.execSQL(Contact.CREATE_TABLE);
    ...
    //now insert the data into databases
...
public Contact getContact(long id){
    ...
    //so here we need to get a data  from the cursor and store its to a contacts obj
    ...
    public int updateContact(Contact contact){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(Contact.COLUMN_NAME, contact.getName());  // Use the correct column name here
